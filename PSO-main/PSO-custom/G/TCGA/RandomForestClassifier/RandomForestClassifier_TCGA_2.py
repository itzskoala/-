...
print("Column names:", tcga_data.columns)

# Ensure the 'Class' column is correctly identified
target_column = 'Class'  # Adjust this if your target column has a different name
...
if target_column not in tcga_data.columns:
    raise KeyError(f"Target column '{target_column}' not found in the dataset")

# Separate features and target
X = tcga_data.drop(target_column, axis=1)
y = tcga_data[target_column]
...
output_file_path = 'PSO-custom/data/selected_features.txt'
